...
function configReducer(state: ConfigState, action: ConfigAction): ConfigState {
  ...
  switch (action.type) {
    ...
    case "TOGGLE_HEADER": {
      ...
      const multi = buildMultiFileState(state.document, newShowHeader, state.omitDefaults, state.activeFile);
      return {
        ...state,
    ...
    case "TOGGLE_OMIT_DEFAULTS": {
      ...
      const multi = buildMultiFileState(state.document, state.showHeader, newOmitDefaults, state.activeFile);
  ...
  const multi = buildMultiFileState(newDoc, state.showHeader, state.omitDefaults, activeFile);
